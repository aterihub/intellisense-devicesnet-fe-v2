...
<template>
  ...
  <div class="xl:bg-[url('@/assets/login-bg.png')] w-full h-full bg-cover absolute z-0 flex p-[20px]">
    <img alt="ateri logo" class="w-[100px] absolute left-[20px] top-[20px] invisible xl:visible" src="../../assets/white-logo.svg" width="125" height="125" />
    <img alt="ateri logo" class="w-[100px] absolute left-[20px] top-[20px] visible xl:invisible" src="../../assets/black-logo.svg" width="125" height="125" />
      ...
      <div class="w-full xl:w-[463px] xl:px-10 xl:py-[42px] bg-bkg-primary rounded-lg flex-col justify-start items-start gap-8 flex">
        ...
        <VeeForm :validationSchema="loginSchema" v-slot="{ handleSubmit }" as="div" class="w-full">
          <form  @submit="handleSubmit($event, onSubmit)" class="form-wrapper" >
            <BasicInput name="username" type="text" placeholder="your username" class="outlined" label="Username" />
